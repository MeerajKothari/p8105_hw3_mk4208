...
* The first obervation shows that User with User ID: **`r pull(instacart, user_id)[1]`** ordered **`r pull(instacart, product_name)[1]`** with the product ID: **`r pull(instacart, product_id)[1]`** from the **`r pull(instacart, aisle)[1]`** aisle of the **`r pull(instacart, department)[1]`** department.
* The second obervation shows that User with User ID: **`r pull(instacart, user_id)[2]`** ordered **`r pull(instacart, product_name)[2]`** with the product ID: **`r pull(instacart, product_id)[2]`** from the **`r pull(instacart, aisle)[2]`** aisle of the **`r pull(instacart, department)[2]`** department.

------------------------------------------------

There are **`r max(pull(instacart, aisle_id))`** aisles. The followin g table shows the aisles from which most number of items were ordered:
...
instacart %>% 
  ...
  labs(
    y = "Number of items", 
    x = "Aisle Name", 
    title = "Number of items ordered in each aisle with more than 10,000 items ordered"
  )
```
...
instacart %>% 
  ...
  knitr::kable(col.names = c("Product Name", "0", "1", "2", "3", "4", "5", "6"))
```
